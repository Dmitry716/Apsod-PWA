...
export const SERVICE_LANDINGS: Partial<Record<ServicePath, ServiceLandingContent>> = {
  'web-development': {
    ...
    heroDevice: 'desktop',
    heroScreen: { src: '/portfolio/amba.png', alt: 'Amba Detail' },
    outcomes: [
      {
        title: 'Канал заявок',
    ...
    screens: [
      ...
      { src: '/portfolio/artdetailing.png', alt: 'ArtDetailing', device: 'desktop' },
    ],
    ...
    cases: [
      {
        title: 'Amba Detail',
        result: 'Витрина услуг с понятным путём к заявке',
        href: '/portfolio/amba-detail',
        image: '/portfolio/amba.png',
      },
      {
        title: 'NEXTON',
        result: 'PWA автосервиса с app-like интерфейсом',
        href: '/portfolio/nexton',
        image: '/portfolio/nexton.png',
      },
      {
        title: 'ArtDetailing',
        result: 'PWA детейлинг-студии под запись и SEO',
