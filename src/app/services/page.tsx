...
const services = [
  ...
  },
  {
    ...
    description:
      'AI-видимость бренда в нейросетях: ChatGPT, Google AI, Алиса — для клиентов по всему миру',
    icon: '🤖',
    fullDescription:
      'GEO-продвижение сайта и бренда в нейросетях (как Generative Engine Optimization): аудит AI-видимости, факт-матрица, тарифы Базовый / Стандарт / Бизнес, доработка контента под AI-ответы и ежемесячный мониторинг. Клиенты по всему миру.',
    features: [
