        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="space-y-4">
            {[
              ...
              {
                q: "Как оцениваете объём PWA?",
                a: "После брифа фиксируем этапы, стек и смету. PWA часто закрывает сценарии iOS и Android одним контуром — без двух отдельных нативных сборок."
              }
            ].map((faq, index) => (
              <div
                key={index}
