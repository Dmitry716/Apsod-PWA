...
export const PORTFOLIO_PROJECTS: PortfolioProject[] = [
  ...
  },
  {
    ...
    challenge:
      'Студии нужна была не визитка, а современный digital-канал: быстрый как приложение, с записью, витриной работ и видимостью в поиске — без конструктора и без зависимости от App Store.',
    solution:
      'Собрали Progressive Web App на ASP.NET Core 10.0 и уникальном коде: установка на домашний экран, app-like интерфейс, каталог услуг (химчистка, полировка, оклейка, защита), фото/видео, запись, SEO под Витебск и база под GEO.',
    results: [
