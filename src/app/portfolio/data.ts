...
export const PORTFOLIO_PROJECTS: PortfolioProject[] = [
  ...
  },
  {
    ...
    type: 'web',
    description:
      'Сайт детейлинг-студии ArtDetailing в Витебске на ASP.NET Core 10: премиальный веб-продукт с каталогом услуг, онлайн-записью и сильным локальным SEO.',
    challenge:
      'Студии нужна была не визитка, а современный digital-канал: быстрый сайт с записью, витриной работ и видимостью в поиске — без конструктора.',
    solution:
      'Собрали веб-приложение на ASP.NET Core 10 и уникальном коде: адаптивный интерфейс, каталог услуг (химчистка, полировка, оклейка, защита), фото/видео, запись и SEO под Витебск.',
    results: [
      'ASP.NET Core 10: производительность и контроль над кодом',
      'Онлайн-запись и витрина услуг/комплексов',
      'Локальное SEO и база под GEO в нейросетях',
    ],
    image: '/portfolio/artdetailing.png',
    tags: ['ASP.NET Core 10', 'SEO', 'GEO'],
