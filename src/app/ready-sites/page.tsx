        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
              Готовый продукт на уникальном коде APSOD: ребренд под ваш бренд, перенос на ваш домен,
              база SEO и GEO. Короче полный цикл с нуля — при том же уровне инженерии.
            </p>
          </div>
