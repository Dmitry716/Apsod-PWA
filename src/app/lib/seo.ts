...
export const SITE_DESCRIPTION =
  'APSOD — профессиональная организация бизнеса в интернете: аналитика, уникальная и безопасная разработка сайтов и приложений на своём коде, SEO и поддержка. Без конструкторов. Витебск, Минск, Москва и удалённо по миру.'
