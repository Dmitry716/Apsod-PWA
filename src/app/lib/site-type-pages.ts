...
export const SITE_TYPE_PAGES: Record<SiteTypeSlug, SiteTypePage> = {
  'landing-page': {
    ...
    lead:
      'Одностраничный сайт под рекламу и заявки: сильный первый экран, оффер, форма и мессенджеры — на собственном коде.',
    ...
    outcomes: [
      ...
      },
      {
        ...
        body: 'Не шаблон конструктора: дизайн и логика под ваш оффер, без чужих лимитов.',
      },
    ],
  ...
  'corporate-sites': {
    ...
    lead:
      'Сайт компании под ключ: услуги, кейсы, команда, контакты и структура под SEO — на собственном коде.',
  ...
  ecommerce: {
    ...
    lead:
      'Каталог, корзина, оплата и доставка на собственном коде — витрина, которую удобно вести и масштабировать.',
