  ...
  return [
    {
      ...
      answer: `Ориентиры: лендинг — от 8 000 BYN, корпоративный сайт — от 15 000 BYN, интернет-магазин — от 23 000 BYN. Для ${cityName} работаем удалённо: бриф, смета и договор онлайн. Актуальные пакеты — на странице «Цены».`,
    },
    {
