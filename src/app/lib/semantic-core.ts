  ...
  return [
    {
      ...
      answer: `Ориентиры: лендинг — от 6 000 BYN, корпоративный сайт — от 12 000 BYN, интернет-магазин — от 15 000 BYN. Для ${cityName} работаем удалённо: бриф, смета и договор онлайн. Актуальные пакеты — на странице «Цены».`,
    },
    {
