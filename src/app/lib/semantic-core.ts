...
export function getServiceSemanticBlocks(
  ...
  return [
    ...
    {
      h2: 'Мобильные приложения под ключ',
...
export function getCityContentBlocks(
  ...
  return [
    ...
    },
    {
      ...
      body: `Заказать сайт ${cityName} можно онлайн: бриф, смета, договор. Ориентиры по стоимости сайта ${nameIn} — на странице «Цены».`,
    },
    {
  ...
  return [
    {
      ...
      answer: `Стоимость сайта ${nameIn}: лендинг — ${formatDualPrice(8000)}, корпоративный сайт / каталог — ${formatDualPrice(15000)}, интернет-магазин — ${formatDualPrice(23000)}. Работаем удалённо: бриф и смета онлайн. Актуальная стоимость — на странице «Цены».`,
    },
    {
