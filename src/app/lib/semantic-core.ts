...
/**
 * Топ коммерческие запросы без гео — для главной /services /contact.
...
export function getServiceSemanticBlocks(
  ...
  if (service === 'web-development') {
    return [
      {
        h2: 'Разработка и создание сайтов',
        body: 'Закажите разработку сайтов и создание сайта с нуля: корпоративный сайт, лендинг или сайт компании — Next.js, Angular, Vue, Svelte или ASP.NET Core.',
      },
      {
        h2: 'Разработка интернет-магазина',
        body: 'Создание интернет-магазина и разработка интернет-магазина полного цикла: каталог, корзина, оплата, доставка, админка и SEO каталога. Точная смета после брифа.',
      },
      {
        h2: 'Сколько стоит сайт',
        body: 'Стоимость сайта и цена разработки зависят от объёма: лендинг, корпоративный сайт или интернет-магазин. Смета после брифа. Закладываем скорость, адаптив и базовую SEO-разметку уже на этапе создания сайта.',
      },
    ]
  }
    ...
    return [
      {
        ...
        body: 'SEO продвижение и продвижение сайта в Яндексе и Google: технический аудит, семантика, контент, внутренняя перелинковка и локальная выдача.',
      },
      {
        h2: 'Продвижение сайта для бизнеса',
        body: 'SEO для коммерческих запросов: семантика, техника, контент и локальная выдача в Яндексе и Google. Подходит для нового сайта и уже работающего проекта.',
      },
      {
        h2: 'Стоимость SEO продвижения',
        body: 'Стоимость SEO продвижения — после аудита и оценки конкуренции; можно начать с точечных работ или ежемесячного цикла. Срок заметного роста позиций по конкурентным запросам обычно 2–4 месяца при системной работе.',
      },
    ]
  }
  ...
  return [
    ...
    {
      h2: 'Мобильные приложения: полный цикл',
      body: 'Заказать мобильное приложение можно онлайн: Discovery, UX, разработка iOS и Android, QA и поддержка после релиза.',
    },
  ]
}
  ...
  return [
    {
      ...
      body: `Разработка сайтов ${cityName} и создание сайта ${nameIn}: корпоративный сайт, лендинг, сайт компании. Проектируем структуру под поисковые запросы ${region}, адаптив и SEO уже на этапе создания сайта с нуля ${nameIn}.`,
    },
    {
      h2: `Заказать сайт ${nameIn}`,
      body: `Заказать сайт ${cityName} можно онлайн: бриф, смета, договор. Стоимость фиксируем в смете после брифа — обычно за 1 рабочий день.`,
    },
    {
      h2: `Интернет-магазин ${nameIn}`,
      body: `Разработка интернет-магазина ${cityName} и создание интернет-магазина ${nameIn}: каталог, корзина, оплата, интеграции и админка. Стек Next.js / Node.js или ASP.NET Core — скорость и удобство SEO каталога.`,
    },
    {
  ...
  return [
    {
      ...
      answer: `Стоимость сайта ${nameIn} зависит от формата: лендинг, корпоративный сайт / каталог или интернет-магазин. Бриф и смета онлайн — через «Контакты», обычно за 1 рабочий день.`,
    },
    {
    ...
    {
      question: `На каком стеке разрабатываете сайты ${nameIn}?`,
      answer: `Стек под задачу: Next.js / React, Angular, Vue, Svelte, ASP.NET Core / C#. Архитектура, скорость и развитие — под ваш продукт.`,
    },
    {
