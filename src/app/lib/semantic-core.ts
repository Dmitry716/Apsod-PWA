    ...
    return [
      {
        ...
        body: 'Закажите разработку сайтов и создание сайта с нуля: корпоративный сайт, лендинг или сайт компании на уникальном коде Next.js / React.',
      },
      {
...
export function getCityFaq(
  ...
  return [
    ...
    },
    {
      ...
      answer: `Только собственный код: Next.js / React. Полный контроль над архитектурой, скоростью и развитием.`,
    },
    {
