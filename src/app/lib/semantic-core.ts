    ...
    return [
      {
        ...
        body: 'Закажите разработку сайтов и создание сайта с нуля: корпоративный сайт, лендинг или сайт компании на уникальном коде. Без конструкторов и типовых CMS-сборок.',
      },
      {
