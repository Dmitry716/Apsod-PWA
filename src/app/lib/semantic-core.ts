  ...
  return [
    {
      ...
      answer: `Стоимость сайта ${nameIn}: лендинг — ${formatDualPrice(8000)}, корпоративный сайт — ${formatDualPrice(15000)}, интернет-магазин — ${formatDualPrice(23000)}. Работаем удалённо: бриф и смета онлайн. Актуальные пакеты — на странице «Цены».`,
    },
    {
