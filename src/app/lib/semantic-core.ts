  ...
  return [
    {
      ...
      body: `Заказывайте разработку сайтов ${cityName}: корпоративный сайт, лендинг или сайт компании на уникальном коде. Мы проектируем структуру под поисковые запросы ${region}, делаем адаптивную вёрстку и закладываем SEO на этапе создания сайта ${nameIn}.`,
    },
    {
      h2: `Интернет-магазин ${nameIn}`,
      body: `Создание интернет-магазина ${cityName}: каталог, корзина, оплата, интеграции и админка. Разработка интернет-магазина ${nameIn} на современном стеке (Next.js, Node.js) — с учётом скорости загрузки и продвижения в поиске.`,
    },
    {
  ...
  return [
    {
      ...
      answer: `Ориентиры: лендинг — от 8 000 Б̶, корпоративный сайт — от 15 000 Б̶, интернет-магазин — от 23 000 Б̶. Для ${cityName} работаем удалённо: бриф, смета и договор онлайн. Актуальные пакеты — на странице «Цены».`,
    },
    {
    ...
    },
    {
      ...
      answer: `За 15 лет — более 350 реальных кейсов. На сайте в портфолио опубликована часть работ (в т.ч. Amba Detail, Maxximum, Динамо-Витебск, NEXTON, BMservice). Остальные проекты можем показать по запросу на консультации ${nameIn}.`,
    },
  ]
}
