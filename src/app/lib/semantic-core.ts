  ...
  if (service === 'web-development') {
    return [
      ...
      },
      {
        ...
        body: 'Стоимость сайта и цена разработки сайта зависят от объёма: лендинг — от 8 000 Б̶, корпоративный сайт — от 15 000 Б̶, интернет-магазин — от 23 000 Б̶. Закладываем скорость, адаптив и базовую SEO-разметку уже на этапе создания сайта.',
      },
    ]
  }
  ...
  if (service === 'seo') {
    return [
      ...
      },
      {
        ...
        body: 'Стоимость SEO продвижения — от 800 Б̶/мес. или пакетный старт после аудита. Срок заметного роста позиций по конкурентным запросам обычно 2–4 месяца при системной работе.',
      },
    ]
  }
  ...
  return [
    {
      ...
      answer: `Стоимость сайта ${nameIn}: лендинг — от 8 000 Б̶, корпоративный сайт — от 15 000 Б̶, интернет-магазин — от 23 000 Б̶. Работаем удалённо: бриф и смета онлайн. Актуальные пакеты — на странице «Цены».`,
    },
    {
