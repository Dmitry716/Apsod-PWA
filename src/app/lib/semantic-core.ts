    ...
    return [
      {
        ...
        body: 'Закажите разработку сайтов и создание сайта с нуля: корпоративный сайт, лендинг или сайт компании на уникальном коде — Next.js, Angular, Vue, Svelte или ASP.NET Core.',
      },
      {
...
export function getCityContentBlocks(
  ...
  return [
    ...
    },
    {
      ...
      body: `Заказать сайт ${cityName} можно онлайн: бриф, смета, договор. Делаем сайт с нуля на уникальном коде. Ориентиры по стоимости сайта ${nameIn} — на странице «Цены».`,
    },
    {
...
export function getCityFaq(
  ...
  return [
    ...
    },
    {
      ...
      answer: `Только собственный код — без конструкторов. Стек под задачу: Next.js / React, Angular, Vue, Svelte, ASP.NET Core / C#. Полный контроль над архитектурой, скоростью и развитием.`,
    },
    {
