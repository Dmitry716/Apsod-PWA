...
export function getServiceSemanticBlocks(
  ...
  if (service === 'web-development') {
    return [
      {
        h2: 'Разработка и создание сайтов в Минске',
        body: 'Закажите разработку сайтов и создание сайта с нуля: корпоративный сайт, лендинг или сайт компании на уникальном коде. Фокус — Минск и компании по Беларуси. Без конструкторов и типовых CMS-сборок.',
      },
      {
    ...
    return [
      {
        ...
        body: 'SEO продвижение и продвижение сайта в Яндексе и Google: технический аудит, семантика, контент, внутренняя перелинковка и локальная выдача. Фокус — Минск и Беларусь.',
      },
      {
        h2: 'Продвижение сайта в Минске',
        body: 'SEO для коммерческих запросов столицы: семантика, техника, контент и локальная выдача в Яндексе и Google. Подходит для нового сайта и уже работающего проекта.',
      },
      {
  ...
  return [
    ...
    {
      h2: 'Мобильные приложения для Минска и Беларуси',
      body: 'Заказать мобильное приложение можно онлайн: Discovery, UX, разработка iOS и Android, QA и поддержка после релиза. Работаем с бизнесом Минска и по всей РБ.',
    },
  ]
}
...
export function getCityFaq(
  ...
  return [
    ...
    },
    {
      ...
      answer: `Только собственный код (Next.js / React). Конструкторы и типовые темы без кастомизации — другой сегмент и другой срок жизни продукта.`,
    },
    {
