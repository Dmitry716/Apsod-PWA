...
export const PAGE_SNIPPETS: Record<string, PageSnippet> = {
  '/': {
    title: 'APSOD — IT-компания и веб-студия',
    description:
      'IT-компания и веб-студия APSOD: сайты и приложения на уникальном коде, SEO и GEO. Минск, Витебск, Москва. Смета за 1 день. Без конструкторов.',
    absoluteTitle: true,
    keywords: GEO_KW,
  },
  '/about': {
    title: 'APSOD — IT-компания и веб-студия',
    description:
      'IT-компания и веб-студия APSOD: уникальная разработка, SEO, приложения. 15+ лет, 350+ кейсов. ИП в Витебске, проекты по РБ, РФ и миру.',
    absoluteTitle: true,
    keywords: [
      'IT компания',
      'IT-компания',
  ...
  '/contact': {
    ...
    description:
      'Бриф за 1 минуту: цель, бюджет, сроки. Telegram @Apsod_IT, WhatsApp, телефон +375445777724. Минск, Витебск, Москва, удалённо.',
  ...
  '/services': {
    title: 'Услуги веб-студии и IT-компании APSOD',
    description:
      'Услуги IT-компании и веб-студии: уникальный код, SEO, GEO, мобильные приложения, техподдержка. Без конструкторов. Полный digital-цикл.',
    keywords: [
      'услуги веб-студии',
      'услуги IT компании',
      'разработка сайтов',
