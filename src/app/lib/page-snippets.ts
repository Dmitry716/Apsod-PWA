...
export const PAGE_SNIPPETS: Record<string, PageSnippet> = {
  ...
  '/pricing': {
    title: 'Цены на сайт и SEO — от 8 000 Б̶',
    description:
      'Лендинг от 8 000 Б̶, корпоративный сайт от 15 000 Б̶, магазин от 23 000 Б̶. SEO от 800 Б̶/мес. Ориентиры для Минска, Витебска, Москвы.',
