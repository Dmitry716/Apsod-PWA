...
export const PAGE_SNIPPETS: Record<string, PageSnippet> = {
  '/': {
    title: 'APSOD — разработка сайтов и SEO без конструкторов',
    description:
      'Сайты и приложения на уникальном коде, SEO и GEO в Яндексе, Google и нейросетях. Минск, Витебск, Москва. Смета за 1 день — от 8 000 Б̶.',
    absoluteTitle: true,
    keywords: GEO_KW,
  },
  '/about': {
