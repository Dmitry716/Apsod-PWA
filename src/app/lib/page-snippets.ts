...
export const PAGE_SNIPPETS: Record<string, PageSnippet> = {
  '/': {
    title: 'APSOD — сайты и рост заявок на уникальном коде',
    description:
      'Разработка без конструкторов, SEO и GEO в Яндексе, Google и нейросетях. Минск, Витебск, Москва. Смета за 1 день — от 8 000 Б̶.',
    absoluteTitle: true,
    keywords: GEO_KW,
  },
  '/about': {
