...
export const PAGE_SNIPPETS: Record<string, PageSnippet> = {
  ...
  '/pricing': {
    ...
    description:
      'Лендинг от 8 000 Б̶ / 240 000 ₽, корпоративный сайт от 15 000 Б̶ / 450 000 ₽, магазин от 23 000 Б̶ / 690 000 ₽. SEO от 800 Б̶ / 24 000 ₽/мес. Разработка сайтов в Минске.',
    keywords: ['стоимость сайта', 'цена разработки сайта', 'стоимость SEO', 'цены на сайт Минск'],
  },
  '/ready-sites': {
  ...
  '/services/web-development': {
    ...
    description:
      'Создание сайта с нуля в Минске: лендинг, корпоративный сайт, каталог. Уникальный код Next.js. Смета после брифа.',
    keywords: [
      'разработка сайтов в Минске',
      'разработка сайтов Минск',
      'создание сайта Минск',
  ...
  '/services/seo': {
    ...
    description:
      'Продвижение сайта в Яндексе и Google в Минске: аудит, семантика, контент. Стоимость SEO — после аудита.',
    keywords: [
      'SEO продвижение Минск',
