...
export default function ChatWidget() {
  ...
  return (
    <>
      {/* Мессенджеры + кнопка чата: отступ от safe-area */}
      {!open && (
        <div
        ...
        >
          <a
            ...
            className="apsod-messenger-fab group relative w-14 h-14 rounded-full bg-[#229ED9] text-white shadow-lg hover:bg-[#1b8ec4] flex items-center justify-center transition-colors touch-none"
            aria-label={t(locale, 'chat.writeTelegram')}
            title={t(locale, 'chat.writeTelegram')}
          >
            <span className="pointer-events-none absolute right-full mr-3 whitespace-nowrap rounded-lg bg-gray-900/90 px-3 py-1.5 text-xs font-medium text-white opacity-0 transition-opacity group-hover:opacity-100 max-md:hidden">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="apsod-messenger-fab group relative w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg hover:bg-[#1ebe57] flex items-center justify-center transition-colors touch-none"
          ...
          <button
            type="button"
            onClick={handleOpen}
            className="w-14 h-14 rounded-full bg-[#1e3a5f] text-white shadow-lg hover:bg-[#2a4a7a] flex items-center justify-center transition-colors touch-none"
