...
export default function HomeGlobalDelivery() {
  return (
    <div className="relative apsod-hero-enter apsod-hero-enter-delay-4">
      <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-7 md:p-8">
        ...
        <ul className="space-y-5 mb-8">
          {POINTS.map((point) => (
            <li key={point.title} className="border-t border-slate-100 dark:border-slate-700 pt-4 first:border-0 first:pt-0">
