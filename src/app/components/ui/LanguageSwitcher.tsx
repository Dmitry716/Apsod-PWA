...
type LanguageSwitcherProps = {
  compact?: boolean;
  /** Nerox-style circular header action */
  circle?: boolean;
  /** Open menu above the trigger (footer) */
  dropUp?: boolean;
  onChange?: () => void;
};
  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        className={
          circle
            ? "apsod-header-circle group text-[12px] font-bold tracking-[0.12em]"
      ...
      >
        {circle ? (
          ...
          <>
            <svg
              className={`w-4 h-4 transition-transform duration-300 ${isOpen ? "rotate-12 scale-110" : "group-hover:rotate-6"}`}
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              strokeWidth="1.8"
            >
              <path
                ...
                d="M3 12h18M12 3a15 15 0 010 18M12 3a15 15 0 000 18M3 12a9 9 0 0118 0 9 9 0 01-18 0z"
              />
            </svg>
            <span
      ...
      {isOpen ? (
        <div
          role="menu"
          className={`absolute right-0 z-50 min-w-[190px] overflow-hidden rounded-xl border border-gray-200 bg-white/95 text-gray-900 shadow-xl backdrop-blur dark:border-white/20 dark:bg-[#111827]/95 dark:text-white ${
