...
export default function AboutPage() {
  const approach = [
    ...
    },
    {
      ...
      body: 'Разработка под ваши задачи — полный контроль над архитектурой и развитием.',
    },
  ]
  ...
  const values = [
    ...
    },
    {
      ...
      description:
        'Индивидуальная инженерия под ваши задачи — полный контроль над архитектурой и развитием.',
    },
    {
      title: 'Прозрачность',
      description:
