...
const SERVICES = [
  ...
  { href: '/services/seo', title: 'SEO-продвижение', desc: 'Яндекс, Google, органика по РФ' },
  { href: '/services/geo-promotion', title: 'GEO-продвижение', desc: 'AI-видимость бренда в нейросетях' },
